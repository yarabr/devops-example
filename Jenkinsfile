...
//         }
        ...
        stage('Build Docker Image') {
            ...
            steps {
                ...
                sh "docker build -f Dockerfile-ci -t ${DOCKER_IMAGE_NAME}/${DOCKER_IMAGE_TAG} --build-arg JAR_FILE=${ARTIFACT_PATH}/${DEPENDENCY_PATH}/${JAR_NAME}.jar --build-arg WAR_FILE=${ARTIFACT_PATH}/${WAR_NAME}.war ."
            }
        }
